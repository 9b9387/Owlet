...
<root>
  ...
  ├── Editor
  │   ├── Undefined.Owlet.Editor.asmdef
  │   └── EditorExample.cs
  ├── Runtime
  │   ├── Undefined.Owlet.asmdef
  │   └── RuntimeExample.cs
  ├── Tests
  │   ├── .tests.json
  │   ├── Editor
  │   │   ├── Undefined.Owlet.Editor.Tests.asmdef
  │   │   └── EditorExampleTest.cs
  │   └── Runtime
  │        ├── Undefined.Owlet.Tests.asmdef
...
1. Enter your package name. The name you choose should contain your default organization followed by the name you typed. For example: `Undefined.Owlet`.
...
To use the Inspector, select the `package.json` file in the Project browser. The **Package Owlet Manifest** page opens for editing.
...
* Store Editor-specific code under a root editor assembly definition file:
  ...
  `Editor/Undefined.Owlet.Editor.asmdef`

* Store runtime-specific code under a root runtime assembly definition file:

  `Runtime/Undefined.Owlet.asmdef`

* Configure related test assemblies for your editor and runtime scripts:

  `Tests/Editor/Undefined.Owlet.Editor.Tests.asmdef`

  `Tests/Runtime/Undefined.Owlet.Tests.asmdef`
...
Use the `Documentations~/Owlet.md` documentation file to create preliminary, high-level documentation. This document should introduce users to the features and sample files included in your package.  Your package documentation files will be used to generate online and local docs, available from the Package Manager UI.
